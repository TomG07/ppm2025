...
const Blackjack: React.FC = () => {
    ...
    const loseSound = useRef(new Audio('/sounds/lose/lose.wav'));
                    ...
                    <table className="result-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Vitórias</td>
                                <td>{stats.wins}</td>
                                <td>{getPercentage(stats.wins)}</td>
                            </tr>
                            <tr>
                                <td>Derrotas</td>
                                <td>{stats.losses}</td>
                                <td>{getPercentage(stats.losses)}</td>
                            </tr>
                            <tr>
                                <td>Empates</td>
                                <td>{stats.ties}</td>
                                <td>{getPercentage(stats.ties)}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
